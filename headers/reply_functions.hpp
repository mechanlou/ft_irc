...
int	rpl_created(int fd, std::string dest_nick, std::string date);
...
int	rpl_userhost(int fd, std::string dest_nick, std::string replies);
int	rpl_ison(int fd, std::string dest_nick, std::string nicks_to_send);
int	rpl_away(int fd, std::string dest_nick, std::string away_msg);
...
int	rpl_whoischannels(int fd, std::string dest_nick, std::string nick, std::string truc);
int	rpl_whowasuser(int fd, std::string dest_nick, std::string nick, std::string user, std::string host, std::string real_name);
...
int	rpl_channelmodeis(int fd, std::string dest_nick, std::string channel, std::string mode, std::string mode_params);
int	rpl_notopic(int fd, std::string dest_nick);
int	rpl_topic(int fd, std::string dest_nick);
int	rpl_inviting(int fd, std::string dest_nick);
int	rpl_summoning(int fd, std::string dest_nick);
int	rpl_exceptlist(int fd, std::string dest_nick);
int	rpl_endofexceptlist(int fd, std::string dest_nick);
int	rpl_version(int fd, std::string dest_nick);
int	rpl_whoreply(int fd, std::string dest_nick);
int	rpl_endofwho(int fd, std::string dest_nick);
int	rpl_namreply(int fd, std::string dest_nick);
int	rpl_endofnames(int fd, std::string dest_nick);
int	rpl_links(int fd, std::string dest_nick);
int	rpl_endoflinks(int fd, std::string dest_nick);
int	rpl_banlist(int fd, std::string dest_nick);
int	rpl_endofbanlist(int fd, std::string dest_nick);
int	rpl_info(int fd, std::string dest_nick);
int	rpl_endofinfo(int fd, std::string dest_nick);
int	rpl_motdstart(int fd, std::string dest_nick);
int	rpl_motd(int fd, std::string dest_nick);
int	rpl_endofmotd(int fd, std::string dest_nick);
int	rpl_youreoper(int fd, std::string dest_nick);
int	rpl_rehashing(int fd, std::string dest_nick);
int	rpl_time(int fd, std::string dest_nick);
int	rpl_usersstart(int fd, std::string dest_nick);
int	rpl_users(int fd, std::string dest_nick);
